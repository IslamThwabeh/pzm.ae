...
// Usage: <div id="contact-section"></div> then <script src="/assets/v20260822/js/contact-loader-517a4859.js"></script>
    ...
    <div class="contact-info">
      <div class="contact-methods">
        <div class="contact-method">
          <img src="/assets/v20260822/images/Header/call-logo-57a15155.png" alt="${copy.phoneAlt}" class="contact-icon-small">
          <a href="tel:+971528026677" dir="ltr">${copy.phoneLabel}</a>
        </div>
        <div class="contact-method">
          <img src="/assets/v20260822/images/Header/whatsapp-logo-6c59b654.png" alt="${copy.whatsappAlt}" class="contact-icon-small">
          <a href="${copy.whatsappHref}" target="_blank" rel="noopener noreferrer">${copy.whatsappLabel}</a>
        </div>
        <div class="contact-method">
          <img src="/assets/v20260822/images/Header/map-logo-e1295862.png" alt="${copy.mapAlt}" class="contact-icon-small">

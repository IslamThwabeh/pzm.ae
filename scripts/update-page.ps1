...
foreach ($line in $lines) {
    ...
    if ($line -match '<body' -and -not $navbarInserted) {
        ...
        $out += '                <a href="https://wa.me/971588366841?text=Hi%2C%20I%27m%20interested%20in%20your%20services.%20(via%20pzm.ae)" class="btn-signup" target="_blank" rel="noopener">WhatsApp</a>'
        $out += '            </div>'

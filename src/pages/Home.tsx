  ...
  return (
    <div>
      ...
      <section className="intro-section bg-white p-8 rounded-lg shadow-md mb-8">
        <h2 className="text-3xl font-bold mb-6 text-center">Welcome to PZM Computers & Phones Store -New•Used•Repair•PC•Build</h2>
        <div className="max-w-3xl mx-auto">
          <p className="text-lg mb-4">
            Located in the heart of Dubai, PZM Computers & Phones Store -New•Used•Repair•PC•Build is your trusted destination for all things tech. 

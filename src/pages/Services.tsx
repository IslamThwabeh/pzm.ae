    ...
    switch (category) {
      case 'brand-new':
        return {
          ...
          description: `At PZM Computers & Mobile Phones - Sell Fix New Used Laptop PC Build, we offer a comprehensive selection of brand new devices from leading manufacturers. All our products come with official warranty and genuine accessories.
...
Visit our store today to explore our latest collection of brand new devices. Our knowledgeable staff will help you find the perfect device that matches your needs and preferences.`,
      ...
      case 'sell-gadgets':
        return {
          ...
          description: `Get the best value for your used electronics with our transparent and efficient buying process. At PZM Computers & Mobile Phones - Sell Fix New Used Laptop PC Build, we offer competitive prices and instant payment for your devices.

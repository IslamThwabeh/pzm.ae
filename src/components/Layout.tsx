...
export function Layout() {
  return (
    <div className="min-h-screen bg-gray-100">
      ...
      <header>
        <div className="header-content">
          ...
          <div className="header-text">
            <h1>PZM Computers & Mobile Phones - Sell Fix New Used Laptop PC Build</h1>
          </div>
        </div>
      </header>
      ...
      {/* Footer */}
      <footer>
        <p>PZM Computers & Mobile Phones - Sell Fix New Used Laptop PC Build<br /> &copy; {new Date().getFullYear()} All rights reserved.</p>
      </footer>
    </div>
  );
}